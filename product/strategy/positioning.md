...
**The white-space:** _designer-grade_ + _T1D-athlete-specific_ + _cross-source_ + _self-hosted_ — each axis has incumbents, but no tool covers all four.
...
What we explicitly do _not_ claim:
