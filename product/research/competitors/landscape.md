...
| **Nightscout**                       | OSS, self-hosted, full CGM + treatments + IOB                          | Caregiver-first UX, looks like a 2014 hospital portal, tries to be everything              | Medium — closest _self-hosted_ competitor, but visually wrong    |
...
| **T1D-athlete-specific**                     | Tidepool is closest, but clinician-shaped                         | T1D-athlete is _the_ audience     |
