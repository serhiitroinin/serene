...
| **No alarms on glucose values** | **Blocks notification, push, phone-call features for glucose.** | Active monitoring with notifications is regulated CGM display function (Sugarmate is *authorized*; we are not). |
